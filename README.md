...
### Authentication
The game uses Supabase Auth with Google SSO. Users must sign in to play and save their progress. See [AUTH_IMPLEMENTATION.md](./AUTH_IMPLEMENTATION.md) for detailed documentation.
